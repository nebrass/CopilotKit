---
title: Quickstart
description: Turn your LangChain agent into an agent-native application in 10 minutes.
icon: "lucide/Play"
hideTOC: true
---
...
If you're planning to deploy your LangGraph agent to AWS Bedrock AgentCore, see the [AgentCore deploy guide](/agentcore).
